...
const GenerateThumbnail = ({setImage, setImagePrompt, image, imagePrompt, setImageStorageId}:GenerateThumbnailProps ) => {
      ...
      {isAiThumbnail ? (
          <div className='flex flex-col gap-5 mt-5'>
            <div className='flex flex-col gap-2.5'>
              ...
              <Textarea 
                className='input-class font-light focus:ring-offset-orange-1'
